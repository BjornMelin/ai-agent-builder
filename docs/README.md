...
- Drizzle configured for `src/db/schema.ts` + `src/db/migrations`
- CI workflows (Biome + ESLint, typecheck, Vitest, build)
- Supply-chain security workflows (CodeQL, Dependency Review, Scorecard)

See `docs/architecture/repository-baseline.md` for exact mappings to repo files.

## Reading order

1. `PRD.md`
2. `docs/architecture/overview.md`
3. `docs/architecture/repository-baseline.md`
4. `docs/specs/requirements.md`
5. `docs/architecture/spec/index.md`
6. `docs/architecture/adr/index.md`
7. `docs/architecture/security.md`
8. `docs/architecture/operations.md`
9. `docs/architecture/runbook.md`

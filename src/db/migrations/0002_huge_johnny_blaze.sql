...
CREATE UNIQUE INDEX "chat_messages_thread_id_message_uid_unique" ON "chat_messages" USING btree ("thread_id","message_uid");--> statement-breakpoint
CREATE UNIQUE INDEX "chat_threads_workflow_run_id_unique" ON "chat_threads" USING btree ("workflow_run_id");--> statement-breakpoint
